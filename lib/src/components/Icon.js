...
const Icon = ({ name, fill, width, bottomColor, height, viewBox, ...otherProps }) => {
  const graphics = {
    ...
    searchBoxIcon: {
      ...
      viewBox: '0 0 18 16',
      content: (
        <G fill="none" fillRule="evenodd" stroke="#0575E6" strokeWidth="1.2" transform="translate(1.4 1.16)">
    ...
    addCircle: {
      ...
      viewBox: '0 0 22 22',
      content: (
        <G fill="none" fillRule="evenodd" stroke="#0575E6" strokeWidth=".8" transform="translate(1 1)">
